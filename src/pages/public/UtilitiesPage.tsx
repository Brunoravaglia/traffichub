                                    ...
                                    {section.tools.map((calc, i) => (
                                        ...
                                        >
                                            <Link
                                                ...
                                                className={`group relative block p-6 rounded-2xl bg-card border ${calc.border} hover:border-primary/40 transition-all hover:shadow-lg hover:shadow-primary/5 hover:-translate-y-1`}
                                            >
                                                {calc.popular && (
                                                    <span className="absolute top-3 right-3 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider bg-primary/10 text-primary rounded-full">
                                                        Popular
                                                    </span>
                                                )}

                                                <div className={`inline-flex p-3 rounded-xl ${calc.bg} mb-4`}>
                                                    <calc.icon className={`w-6 h-6 ${calc.color}`} />
                                                </div>

                                                <h3 className="text-xl font-bold mb-0.5 group-hover:text-primary transition-colors">
                                                    {calc.title}
                                                </h3>
