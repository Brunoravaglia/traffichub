...
import { Plus, Users, BarChart3, UserPlus, Briefcase, TrendingUp, CheckCircle2, AlertCircle, FileText } from "lucide-react";
      ...
      <main className="container mx-auto px-6 py-8 relative z-10">
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            <motion.div variants={itemVariants} animate={floatAnimation} className="vcd-card group hover:border-primary/30 transition-all duration-300">
            ...
            <motion.div variants={itemVariants} animate={floatAnimation} style={{ animationDelay: "0.5s" }} className="vcd-card group hover:border-primary/30 transition-all duration-300">
              <div className="flex items-center justify-between mb-3">
                <div className="w-12 h-12 rounded-2xl bg-primary/10 flex items-center justify-center group-hover:scale-110 transition-transform">
            ...
            <motion.div variants={itemVariants} animate={floatAnimation} style={{ animationDelay: "1s" }} className="vcd-card group hover:border-primary/30 transition-all duration-300">
              <div className="flex items-center justify-between mb-3">
            ...
            <motion.div variants={itemVariants} animate={floatAnimation} style={{ animationDelay: "1.5s" }} className="vcd-card group hover:border-primary/30 transition-all duration-300">
              <div className="flex items-center justify-between mb-3">
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              ...
              >
                ...
                <h4 className="font-semibold text-foreground group-hover:text-primary transition-colors">Novo Gestor</h4>
              </motion.button>
            </div>
          </motion.div>
